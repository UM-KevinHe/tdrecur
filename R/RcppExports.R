...
update_beta <- function(l, lchange, L1, L2, Sm, t_start, t_end, events_per_day_facility, z, Z_tv, t_tv, max_v, beta, update, update_rel, facility_idx, hosp_begin, max_d, parallel = TRUE, nthreads = 1L) {
    invisible(.Call('_tdrecur_update_beta', PACKAGE = 'tdrecur', l, lchange, L1, L2, Sm, t_start, t_end, events_per_day_facility, z, Z_tv, t_tv, max_v, beta, update, update_rel, facility_idx, hosp_begin, max_d, parallel, nthreads))
}
...
#'@param num_events total number of events
#'@param events_per_facility number of events by facility
update_alpha11 <- function(alpha, S0, t_start, t_end, events_per_day, exp_z_beta0, diffalpha, alpha_star, z, Z_tv, t_tv, max_v, beta, facility, num_facility, D, lambda, num_events, events_per_facility, N, Epre, hosp_begin, max_d, parallel = TRUE, nthreads = 1L) {
    invisible(.Call('_tdrecur_update_alpha11', PACKAGE = 'tdrecur', alpha, S0, t_start, t_end, events_per_day, exp_z_beta0, diffalpha, alpha_star, z, Z_tv, t_tv, max_v, beta, facility, num_facility, D, lambda, num_events, events_per_facility, N, Epre, hosp_begin, max_d, parallel, nthreads))
}
...
#'
#'@export
cox_breslow_dep <- function(hosp_begin, max_d, t_start, t_end, z, Z_tv, t_tv, max_v, tolb, tola, maxiter, facility, num_facility, D, beta, parallel = TRUE, nthreads = 1L) {
    .Call('_tdrecur_cox_breslow_dep', PACKAGE = 'tdrecur', hosp_begin, max_d, t_start, t_end, z, Z_tv, t_tv, max_v, tolb, tola, maxiter, facility, num_facility, D, beta, parallel, nthreads)
}
...
ddloglik_cpp14 <- function(alpha, t_start, t_end, Z_tv, t_tv, max_v, z, beta, D, N, S0, exp_z_beta0) {
    invisible(.Call('_tdrecur_ddloglik_cpp14', PACKAGE = 'tdrecur', alpha, t_start, t_end, Z_tv, t_tv, max_v, z, beta, D, N, S0, exp_z_beta0))
}
...
#'@param num_events total number of events
#'@param O number of events by facility
update_alpha_ind <- function(alpha, S0, t_start, t_end, dm, exp_z_beta, exp_z_beta0, diffalpha, alpha_star, facility, num_facility, D, lambda, num_events, O, N, Epre) {
    invisible(.Call('_tdrecur_update_alpha_ind', PACKAGE = 'tdrecur', alpha, S0, t_start, t_end, dm, exp_z_beta, exp_z_beta0, diffalpha, alpha_star, facility, num_facility, D, lambda, num_events, O, N, Epre))
}
...
#'@param D number of distinct failure time number of days)
#'@param z time-independent variables
compute_d_omp <- function(hosp_begin, max_d, D, z, Z_tv, t_tv, max_v, facility, num_facility, nthreads = 1L) {
    .Call('_tdrecur_compute_d_omp', PACKAGE = 'tdrecur', hosp_begin, max_d, D, z, Z_tv, t_tv, max_v, facility, num_facility, nthreads)
}
...
#'@param Sm 1 by p vector
#'@param ym number of changes on each day
ddloglik_omp <- function(L1, L2, t_start, t_end, Sm, events_per_day_facility, z, Z_tv, t_tv, max_v, beta, N, facility_idx, hosp_begin, max_d, nthreads = 1L) {
    invisible(.Call('_tdrecur_ddloglik_omp', PACKAGE = 'tdrecur', L1, L2, t_start, t_end, Sm, events_per_day_facility, z, Z_tv, t_tv, max_v, beta, N, facility_idx, hosp_begin, max_d, nthreads))
}

#'@param max_v max number of variable change, patient by variable
#'@param D number of distinct failure time (number of days)
#'@param exp_z_beta0 N by D matrix
ddloglik_all_omp <- function(alpha, t_start, t_end, Z_tv, t_tv, max_v, z, beta, D, N, S0, exp_z_beta0, hosp_begin, max_d, nthreads = 1L) {
    invisible(.Call('_tdrecur_ddloglik_all_omp', PACKAGE = 'tdrecur', alpha, t_start, t_end, Z_tv, t_tv, max_v, z, beta, D, N, S0, exp_z_beta0, hosp_begin, max_d, nthreads))
}
